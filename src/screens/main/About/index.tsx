...
const AboutScreen = () => {
  const onDialNumber = (num: any) => {
    if (num) {
      ...
      console.log("phoneNumberToDial", phoneNumberToDial);
    ...
    >
      ...
      >
        ...
        <View style={styles.textPoints}>
          ...
          />
          <CustomText
            text={`Three Physical Stores in Lahore: Our flagship store in Gulberg, along with two other locations in DHA and Urdu Bazar, cater to book lovers across the city. Notably, Readings DHA is home to the largest and most modern bookstore and coffee shop in Pakistan.`}
            lineHeight={20}
            style={{ textAlign: "justify" }}
            size={14}
          />
        ...
        >
          <View style={{ ...styles.textPoints, marginLeft: scale(0) }}>
            ...
            />
            <CustomText
              text={`Gulberg 12-K, Main Boulevard, Gulberg 2, Lahore`}
              lineHeight={20}
              style={{ textAlign: "justify" }}
              size={14}
            />
        ...
        >
          <View style={{ ...styles.textPoints, marginLeft: scale(0) }}>
            ...
            />
            <CustomText
              text={`DHA 21-FF Market, Phase IV, DHA, Lahore`}
              lineHeight={20}
              style={{ textAlign: "justify" }}
              size={14}
            />
        ...
        >
          <View style={{ ...styles.textPoints, marginLeft: scale(0) }}>
            ...
            />
            <CustomText
              text={`Urdu Bazar Al-Habib Plaza, 38 Urdu Bazar, Lahore `}
              lineHeight={20}
              style={{ textAlign: "justify" }}
              size={14}
            />
