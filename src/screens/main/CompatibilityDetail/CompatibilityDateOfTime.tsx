...
const CompatibilityDateOfTime = ({ navigation }: any) => {
      ...
      <ScreenLayout style={styles.main}>
        ...
        <View style={{ alignItems: "center", flex: 1 }}>
          ...
          >
            ...
            >
              <CustomButton
                onPress={() => navigation.navigate("CompatibilityAddGender")}
                width={"48%"}
                text="I DON’T KNOW"
...
export default CompatibilityDateOfTime;
