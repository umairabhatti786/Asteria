  ...
  return (
    ...
    >
      ...
      >
        ...
        <View style={{ ...styles.textPoints, marginLeft: scale(0) }}>
          <CustomText text={`1.`} lineHeight={20} fontWeight="600" size={14} />
          <CustomText
            text={
              "Usage Data: Information about your interactions with our site, including page visits and click patterns."
            }
        ...
        <View style={{ ...styles.textPoints, marginLeft: scale(0) }}>
          <CustomText text={`2.`} lineHeight={20} fontWeight="600" size={14} />
          <CustomText
            text={
        ...
        <View style={{ ...styles.textPoints, marginLeft: scale(0) }}>
          <CustomText text={`3.`} lineHeight={20} fontWeight="600" size={14} />
          <CustomText
            text={
        ...
        <View style={{ ...styles.textPoints, marginLeft: scale(0) }}>
          <CustomText text={`4.`} lineHeight={20} fontWeight="600" size={14} />
          <CustomText
            text={
        ...
        <View style={{ ...styles.textPoints, marginLeft: scale(0) }}>
          <CustomText text={`5.`} lineHeight={20} fontWeight="600" size={14} />
          <CustomText
            text={
