...
const RightHandReading = ({ navigation }: any) => {
  const ProAndCons = [
      ...
      <View style={{ padding: scale(15), gap: verticalScale(20) }}>
        ...
        <View style={styles.box}>
          ...
          >
            <CustomText
              text={
                "Your Love Line shows that you are very passionate and can freely express your thoughts and feelings."
              }
              size={15}
            ...
            <CustomText
              text={
                "Your Health Line means positive changes or recovery from illness in your future and overall completion of your life goals."
              }
              size={15}
              color={colors.white + "80"}
            />
            ...
            <CustomText
              text={
                "Your Fate Line shows the fortune of your career or job."
              }
              size={15}
              color={colors.white + "80"}
            />
             <CustomText
              text={
                "Your Life Line indicates your life durability. "
              }
              size={15}
              color={colors.white + "80"}
            />
...
export default RightHandReading;
